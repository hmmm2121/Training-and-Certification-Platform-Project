...
namespace TrainingAndCertificationPlatform.Controllers
{
    ...
    public class CertificationTracksController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (certificationTrack != null)
            {
                _context.TrackCourses.RemoveRange(certificationTrack.TrackCourses);
                _context.TraineeCertifications.RemoveRange(certificationTrack.TraineeCertifications);
                _context.CertificationTracks.Remove(certificationTrack);
                await _context.SaveChangesAsync();
                TempData["SuccessMessage"] = $"Track \"{certificationTrack.Name}\" has been deleted.";
            }
