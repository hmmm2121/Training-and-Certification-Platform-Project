                ...
                .Select(c => new SelectListItem
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            var course = await _context.Courses
                ...
                .Include(c => c.InversePrerequisiteCourse)
            ...
            if (course != null)
            {
                ...
                _context.CourseSessions.RemoveRange(course.CourseSessions);

                foreach (var dependent in course.InversePrerequisiteCourse)
                {
                    dependent.PrerequisiteCourseId = null;
                }

                _context.TrackCourses.RemoveRange(course.TrackCourses);
                _context.Courses.Remove(course);
                await _context.SaveChangesAsync();
                TempData["SuccessMessage"] = $"Course \"{course.Title}\" has been deleted.";
            }
